...
export const PRODUCTS: ShopProduct[] = [
  ...
  // -------------------- AI builds --------------------
  {
    ...
    tagline: '111 services, 1,640+ tools, 1-week ship.',
    blurb: 'Drop the 0nMCP orchestrator into your stack. 111 services, 1,640+ tools, vault-secured credentials, and a custom integration plan in 1 week.',
    priceCents: 199_700,
    priceLabel: '$1,997',
    delivery: '1 week',
    icon: Workflow,
    ...
    features: [
      ...
      '1,640+ tools available out of the box',
