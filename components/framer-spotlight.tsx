...
export default function FramerSpotlight() {
  ...
  // Define multiple spotlight colors (now red-themed)
  const spotlightColors = [
    { color: "rgba(255, 50, 50, 0.2)", darkColor: "rgba(255, 60, 60, 0.25)" }, // Primary Red
    { color: "rgba(255, 100, 100, 0.15)", darkColor: "rgba(255, 110, 110, 0.2)" }, // Lighter Red
    { color: "rgba(200, 40, 40, 0.15)", darkColor: "rgba(210, 50, 50, 0.2)" }, // Deeper Red
  ]
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Additional colored spotlights - adjusted to red theme */}
      <motion.div
        className="absolute pointer-events-none"
        initial={{ opacity: 0 }}
        animate={{
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(255, 80, 80, 0.2)" : "rgba(255, 90, 90, 0.15)" // Another red shade
          } 0%, transparent 70%)`,
          width: "600px",
          height: "600px",
          borderRadius: "50%",
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(255, 120, 120, 0.2)" : "rgba(255, 130, 130, 0.15)" // Yet another red shade
          } 0%, transparent 70%)`,
          width: "550px",
          height: "550px",
          borderRadius: "50%",
