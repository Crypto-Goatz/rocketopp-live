...
import {
  ...
  ShoppingBag,
  // Required for the new "Our Apps" restructure (VerifiedSXO + CRO9 entries).
  // Forgetting these in commit 837c666 was the root cause of the 2026-05-01
  // homepage hydration crash — undefined icon refs threw on client render.
